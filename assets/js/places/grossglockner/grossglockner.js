...
p.nominalBounds = new cjs.Rectangle(251.2,351.2,57.6,63.5);
...
(lib.gk_sc2_layer1_auto = function(mode,startPosition,loop) {
	...
	var mask_graphics_8 = new cjs.Graphics().p("");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:37.5,y:1.6}).wait(8).to({graphics:mask_graphics_8,x:346.7,y:361}).wait(121));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).wait(1).to({regX:38,x:38,y:33},0).wait(1).to({y:31},0).wait(1).to({y:29},0).wait(1).to({y:26.9},0).wait(1).to({y:24.8},0).wait(1).to({y:22.7},0).wait(1).to({y:20.5},0).wait(1).to({y:18.4},0).wait(1).to({y:16.2},0).wait(1).to({y:15},0).wait(1).wait(1).to({y:13.7},0).wait(1).to({y:12.4},0).wait(1).to({y:11},0).wait(1).to({y:9.6},0).wait(1).to({y:8.2},0).wait(1).to({y:6.8},0).wait(1).to({y:5.4},0).wait(1).to({y:4},0).wait(1).to({y:2.5},0).wait(1).to({y:1.1},0).wait(1).to({y:-0.2},0).wait(1).to({y:-0.8},0).wait(1).to({scaleX:1,scaleY:1,x:38.4,y:0.1},0).wait(1).to({scaleX:1.01,scaleY:1.01,x:39.9,y:3.9},0).wait(1).to({scaleX:1.02,scaleY:1.02,x:41.5,y:7.7},0).wait(1).to({scaleX:1.03,scaleY:1.03,x:43,y:11.5},0).wait(1).to({scaleX:1.04,scaleY:1.04,x:44.5,y:15.4},0).wait(1).to({scaleX:1.05,scaleY:1.05,x:46.1,y:19.3},0).wait(1).to({scaleX:1.06,scaleY:1.06,x:47.7,y:23.2},0).wait(1).to({scaleX:1.07,scaleY:1.07,x:49.3,y:27.2},0).wait(1).to({scaleX:1.08,scaleY:1.08,x:50.9,y:31.2},0).wait(1).to({scaleX:1.09,scaleY:1.09,x:52.4,y:35.2},0).wait(1).to({scaleX:1.1,scaleY:1.1,x:54.1,y:39.2},0).wait(1).to({scaleX:1.11,scaleY:1.11,x:55.7,y:43.3},0).wait(1).to({scaleX:1.12,scaleY:1.12,x:57.4,y:47.4},0).wait(1).to({scaleX:1.13,scaleY:1.13,x:59,y:51.6},0).wait(1).to({scaleX:1.14,scaleY:1.14,x:60.7,y:55.8},0).wait(1).to({scaleX:1.15,scaleY:1.15,x:62.4,y:60},0).wait(1).to({scaleX:1.16,scaleY:1.16,x:64.1,y:64.2},0).wait(1).to({scaleX:1.17,scaleY:1.17,x:65.8,y:68.5},0).wait(1).to({scaleX:1.18,scaleY:1.18,x:67.5,y:72.8},0).wait(1).to({scaleX:1.19,scaleY:1.19,x:69.2,y:77.1},0).wait(1).to({scaleX:1.2,scaleY:1.2,x:71,y:81.5},0).wait(1).to({scaleX:1.21,scaleY:1.21,x:72.7,y:85.9},0).wait(1).to({scaleX:1.22,scaleY:1.22,x:74.5,y:90.3},0).wait(1).to({scaleX:1.23,scaleY:1.23,x:76.3,y:94.8},0).wait(1).to({scaleX:1.24,scaleY:1.24,x:78.1,y:99.3},0).wait(1).to({scaleX:1.25,scaleY:1.25,x:79.9,y:103.8},0).wait(1).to({scaleX:1.26,scaleY:1.26,x:81.7,y:108.3},0).wait(1).to({scaleX:1.27,scaleY:1.27,x:83.6,y:113},0).wait(1).to({scaleX:1.29,scaleY:1.29,x:85.4,y:117.6},0).wait(1).to({scaleX:1.3,scaleY:1.3,x:89.6,y:122.2},0).wait(1).to({scaleX:1.31,scaleY:1.31,x:94.7,y:126.9},0).wait(1).to({scaleX:1.32,scaleY:1.32,x:99.9,y:131.7},0).wait(1).to({scaleX:1.33,scaleY:1.33,x:105.1,y:136.4},0).wait(1).to({scaleX:1.34,scaleY:1.34,x:110.3,y:141.2},0).wait(1).to({scaleX:1.35,scaleY:1.35,x:115.6,y:146},0).wait(1).to({scaleX:1.37,scaleY:1.37,x:121,y:150.8},0).wait(1).to({scaleX:1.38,scaleY:1.38,x:126.3,y:155.7},0).wait(1).to({scaleX:1.39,scaleY:1.39,x:131.7,y:160.6},0).wait(1).to({scaleX:1.4,scaleY:1.4,x:137.2,y:165.5},0).wait(1).to({scaleX:1.41,scaleY:1.41,x:142.6,y:170.5},0).wait(1).to({scaleX:1.43,scaleY:1.43,x:148.1,y:175.5},0).wait(1).to({scaleX:1.44,scaleY:1.44,x:153.6,y:180.5},0).wait(1).to({scaleX:1.45,scaleY:1.45,x:159.2,y:185.6},0).wait(1).to({scaleX:1.46,scaleY:1.46,x:164.8,y:190.7},0).wait(1).to({scaleX:1.47,scaleY:1.47,x:170.5,y:195.8},0).wait(1).to({scaleX:1.49,scaleY:1.49,x:176.2,y:201},0).wait(1).to({scaleX:1.5,scaleY:1.5,x:181.8,y:206.1},0).wait(1).to({scaleX:1.51,scaleY:1.51,x:187.6,y:211.4},0).wait(1).to({scaleX:1.52,scaleY:1.52,x:193.3,y:216.6},0).wait(1).to({scaleX:1.54,scaleY:1.54,x:199.2,y:221.9},0).wait(1).to({scaleX:1.55,scaleY:1.55,x:205,y:227.2},0).wait(1).to({scaleX:1.56,scaleY:1.56,x:210.9,y:232.6},0).wait(1).to({scaleX:1.58,scaleY:1.58,x:216.9,y:238},0).wait(1).to({scaleX:1.59,scaleY:1.59,x:220.6,y:245.3},0).wait(1).to({scaleX:1.61,scaleY:1.61,x:223.9,y:253.1},0).wait(1).to({scaleX:1.62,scaleY:1.62,x:227.1,y:261},0).wait(1).to({scaleX:1.64,scaleY:1.64,x:230.4,y:268.9},0).wait(1).to({scaleX:1.65,scaleY:1.65,x:233.8,y:276.9},0).wait(1).to({scaleX:1.67,scaleY:1.67,x:237.1,y:284.9},0).wait(1).to({scaleX:1.69,scaleY:1.69,x:240.4,y:293},0).wait(1).to({scaleX:1.7,scaleY:1.7,x:243.8,y:301.1},0).wait(1).to({scaleX:1.72,scaleY:1.72,x:247.3,y:309.3},0).wait(1).to({scaleX:1.73,scaleY:1.73,x:250.7,y:317.5},0).wait(1).to({scaleX:1.75,scaleY:1.75,x:254.1,y:325.7},0).wait(1).to({scaleX:1.77,scaleY:1.77,x:257.6,y:334},0).wait(1).to({scaleX:1.78,scaleY:1.78,x:261,y:342.3},0).wait(1).to({scaleX:1.8,scaleY:1.8,x:264.5,y:350.7},0).wait(1).to({scaleX:1.82,scaleY:1.82,x:268,y:359.1},0).wait(1).to({scaleX:1.83,scaleY:1.83,x:271.5,y:367.6},0).wait(1).to({scaleX:1.85,scaleY:1.85,x:275.1,y:376.1},0).wait(1).to({scaleX:1.87,scaleY:1.87,x:278.7,y:384.7},0).wait(1).to({scaleX:1.88,scaleY:1.88,x:282.2,y:393.3},0).wait(1).to({scaleX:1.9,scaleY:1.9,x:285.8,y:401.9},0).wait(1).to({scaleX:1.92,scaleY:1.92,x:289.5,y:410.6},0).wait(1).to({scaleX:1.93,scaleY:1.93,x:293.1,y:419.4},0).wait(1).to({scaleX:1.95,scaleY:1.95,x:296.5,y:428.1},0).wait(1).to({scaleX:1.97,scaleY:1.97,x:299,y:436.3},0).wait(1).to({scaleX:1.99,scaleY:1.99,x:301.5,y:444.5},0).wait(1).to({scaleX:2,scaleY:2,x:304.1,y:452.8},0).wait(1).to({scaleX:2.02,scaleY:2.02,x:306.6,y:461.1},0).wait(1).to({scaleX:2.04,scaleY:2.04,x:309.1,y:469.5},0).wait(1).to({scaleX:2.06,scaleY:2.06,x:311.7,y:477.9},0).wait(1).to({scaleX:2.08,scaleY:2.08,x:314.3,y:486.3},0).wait(1).to({scaleX:2.09,scaleY:2.09,x:316.9,y:494.8},0).wait(1).to({scaleX:2.11,scaleY:2.11,x:319.5,y:503.4},0).wait(1).to({scaleX:2.13,scaleY:2.13,x:322.1,y:511.9},0).wait(1).to({scaleX:2.15,scaleY:2.15,x:324.7,y:520.6},0).wait(1).to({scaleX:2.17,scaleY:2.17,x:327.4,y:529.3},0).wait(1).to({scaleX:2.18,scaleY:2.18,x:330,y:538},0).wait(1).to({scaleX:2.2,scaleY:2.2,x:339.7,y:548.4},0).wait(1).to({scaleX:2.22,scaleY:2.22,x:351.3,y:559.4},0).wait(1).to({scaleX:2.24,scaleY:2.24,x:363,y:570.4},0).wait(1).to({scaleX:2.26,scaleY:2.26,x:374.8,y:581.5},0).wait(1).to({scaleX:2.28,scaleY:2.28,x:386.6,y:592.7},0).wait(1).to({scaleX:2.3,scaleY:2.3,x:398.5,y:603.9},0).wait(1).to({scaleX:2.32,scaleY:2.32,x:410.4,y:615.1},0).wait(1).to({scaleX:2.34,scaleY:2.34,x:422.5,y:626.5},0).wait(1).to({scaleX:2.35,scaleY:2.35,x:434.5,y:637.8},0).wait(1).to({scaleX:2.37,scaleY:2.37,x:446.6,y:649.3},0).wait(1).to({scaleX:2.39,scaleY:2.39,x:458.8,y:660.7},0).wait(1).to({scaleX:2.41,scaleY:2.41,x:471,y:672.2},0).wait(1).to({scaleX:2.43,scaleY:2.43,x:483.3,y:683.8},0).wait(1).to({scaleX:2.45,scaleY:2.45,x:495.6,y:695.4},0).wait(1).to({scaleX:2.47,scaleY:2.47,x:508,y:707.1},0).wait(1));
