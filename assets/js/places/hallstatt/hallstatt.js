...
(lib.gk_sc1_photo_closeButton = function() {
	...
	this.shape.graphics.f().s("#000000").ss(2.6,1,1).p("AkdjbIEhDtIi9EkAEeD6IkajoIDXlH");
	this.shape.setTransform(-3.7,9.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AiqGTQiZhhg7i8Qg6i5BHioQBIinCegxQCdgxCZBhQCaBiA6C8QA6C5hHCnQhHCoifAxQg2AQg0AAQhmABhmhCgAjLE4IC/kkIkjjuIEjDugAgMAUIEZDoIkZjoIDWlIIjWFIg");
...
(lib.hs_sc1_layer4_kirche = function(mode,startPosition,loop) {
	...
	// Ebene 5
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#484848").ss(1,1,1).p("");
	...
	// Ebene 4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#DDDCDC").ss(1,1,1).p("");
...
(lib.hs_sc2_layer2_tuer_2 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(49).call(this.frame_49).wait(204).call(this.frame_253));
...
(lib.hs_sc3_layer2_anim2 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(17).call(this.frame_17).wait(62).call(this.frame_79));
...
(lib.hs_sc3_layer2_anim1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(82.1,362.1,4.739,4.739,10,0,0,65.9,88);
...
(lib.hs_sc2_layer2_fenster_1 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(24).call(this.frame_24).wait(184).call(this.frame_208));
